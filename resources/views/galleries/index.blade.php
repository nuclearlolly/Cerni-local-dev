...
<div class="row justify-content-center">
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <p style="text-align: left;">"Ooo a visitor! Welcome to the <strong>Gallery</strong>, here you can find all of the wonderful work our community has done! I am <a href="http://localhost/character/NPC-003"><strong>Vivo</strong></a>, if you need anything, just yell my name!"</p>
                <p style="text-align: left;">"Oh, you don't know how to use the gallery? No biggie! Click on the guide below to learn how to upload your prompt work!"</p>
                    <div class="card mb-4"  style="border-top-right-radius: 1.8em; border-top-left-radius: 1.7em; box-shadow: 0px 0px 6px 3px rgba(70, 0, 136, 0.08);">
                        <button class="collapsible text-center"><h5>Gallery Guide ▾</h5></button>
                        ...
                        <p>"Click on the <img src="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/9a7ad07f-4b02-4a9f-baec-6981cebc1ebb/dkup49f-72640024-961b-44eb-b5ca-79b5dbcca5a5.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..7COFXyIopeqH5vIWkECfr5_R5-UfaQbsUyPn2GrEbp0" alt="Plus" width="35" height="35" />to upload your prompt. After that, everything should be very straightforward! Upload the art or literature that you have done to complete a prompt, add a title, description (if needed!), any content warning if needed, select a prompt, and then add all the characters that are present in the prompt! And done! After that, all you need to do is submit the prompt and link to the gallery post you made! Easy peasy."</p>
                        </div>
