...
<div class="header"><img class="header-img" style="border: 7px double #FFE9EF; border-radius: 20px;  background-image: url('{{ $user->profileImgUrl }}'); background-position: top middle; text-align: center; background-size: cover;"></div>
...
<hr class="mb-6"/>
    ...
    @if ($user->settings->allow_profile_comments)
            ...
            <div class="card"  style="border-top-right-radius: 1.8em; border-top-left-radius: 1.7em; box-shadow: 0px 0px 6px 3px rgba(70, 0, 136, 0.08);">
